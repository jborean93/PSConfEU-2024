...
@{
    ...
    RootModule = 'bin/Release/net7.0/publish/PythonForge.dll'
    ...
    GUID = '8d91c247-4b1d-464e-a893-3e3d5b6d5ea8'
    ...
    Description = 'RemoteForge implementation for Python targets'
